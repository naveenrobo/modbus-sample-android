        ...
        if (request.expectsResponse()) {
            ...
            try {
                do {
                    ...
                    // Switch to receive mode after writing
                    ...
                    Log.i("MessageControl", "response : " + response);
...
//        if (ioLog != null)
//            ioLog.input(b, 0, len);
        Log.i("MessageControl", "Incoming data : " + StreamUtils.dumpHex(b, 0, len));
...
//            ioLog.output(data);
        ...
        synchronized (transport) {
            try {
                Log.i("MessageControl", "write: Writing data out");
